<div class="container my-3">
    <div class="card">
        <div class="card-header justify-content-baseline">
           ...
           <a href="/add/user" wire:navigate  class=" btn btn-success float-end mx-2">Add New User</a>
  ...
  <tbody>
    ...
    <tr class="text-center">
      ...
      <td ><a  href="/edit/user/{{$item->id}}" wire:navigate  class="btn btn-primary btn-sm shadow" >EDIT</td>
