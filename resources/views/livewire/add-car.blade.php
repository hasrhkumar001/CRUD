<div class="container my-3">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form wire:submit.prevent="saveCar" enctype="multipart/form-data">
                <div class="row">
                    <div class="mb-3 col-6">
                        <label for="car_name" class="form-label">Car Name</label>
                        <input type="text" class="form-control" wire:model.lazy="car_name" id="car_name" placeholder="Enter Car Name">
                        @error('car_name')
                    ...
                    <div class="mb-3 col-6">
                        ...
                        <input type="text" class="form-control" wire:model.lazy="brand_name" id="brand_name" placeholder="Enter Brand Name">
                        @error('brand_name')
                            <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                ...
                <div class="row">
                    <div class="mb-3 col-4">
                        ...
                        <input type="number" step="0.1" min="0" class="form-control" wire:model.lazy="car_mileage" id="car_mileage" placeholder="Enter Car Mileage">
                        @error('car_mileage')
                            <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3 col-4">
                        ...
                        <input type="text" class="form-control" wire:model.lazy="car_price_range" id="car_price_range" placeholder="Enter Car Price Range (e.g., 10000-50000)">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" wire:model.lazy="car_desc" id="car_desc" placeholder="Enter Car Description">
                    @error('car_desc')
                        <span class="text-danger">{{$message}}</span>
                    @enderror
                </div>
